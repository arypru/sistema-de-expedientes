<template>
  <div>
    <v-card style="background: #ebdbc8" class="my-6 px-4 pa-5">
...
<script>
import ModalNuevaCedula from "../Modals/ModalNuevaCedula";
import ModalDetalleCedula from "../Modals/ModalDetalleCedula";
